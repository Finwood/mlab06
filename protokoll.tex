...
Bla Bla Referenz \textbf{Abbildung~\ref{fig:plot-ausschwingen}} \todo{Anna}
...
Wie aus \textbf{Abbildung~\ref{fig:plot-kennkreis}} hervorgeht, ist das hier alles vollkommen korrekt. Anna, denk dir doch ein paar Sätze aus :-) \todo{Anna}
