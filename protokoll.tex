...
Um das Tr\"agheitsmoment der Alum\"ainiumscheibe zu berechnen, sehen wir diese als Zylinder an. Die Formel zur Berechnung des Tr\"ogheitsmoments entnehmen wir der Literatur.
...
\begin{gather}
	R = \SI{0,2}{\meter}
	h = \SI{9,4 \cdot 10^{-3}}{\meter}
	\rho = \SI{2,7 \cdot 10^6}{\gram\per\cubic\meter}\\
	M = \rho \cdot \pi \cdot R^2 \cdot h 
	= \SI{2,7 \cdot 10^6}{\gram\per\cubic\meter} \cdot \pi \cdot {\SI{0,2}{\meter}}^2 \cdot 
	\SI{9,4 \cdot 10^{-3}}{\meter} = \SI{3,189}{\kilogram}
\end{gather}

\begin{equation}
	J_z = \frac{1}{2} \cdot \SI{3,189}{\kilogram} \cdot {\SI{0,2}{\meter}}^2 = \SI{0,06}{\joule}
\end{equation}
		
Somit ergibt sich das Tr\"agheitsmoment der Aluminiumscheibe zu $\SI{0,06}{\joule}$
